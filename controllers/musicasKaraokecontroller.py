...
from models.musicas_karaoke import filter_karaoke_data, load_karaoke_data
...
from models.musicas_karaoke import my_model

def my_controller():
    st.write("Controlador de músicas karaoke - Regras de negócio")
    # A lista de músicas é obtida da model (está aqui)
    my_model()
"""